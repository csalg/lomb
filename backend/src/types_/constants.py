...
WORD_WAS_IGNORED="WORD_WAS_IGNORED"
...
SUCCESS_MESSAGES = [BOOK_DRILL_SCROLL, REVISION__NOT_CLICKED, TEXT__SENTENCE_READ]
FAILURE_MESSAGES = [BOOK_DRILL_CLICK, REVISION__CLICKED, TEXT__WORD_HIGHLIGHTED]
